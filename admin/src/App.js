...
// MODULE SURPRISE DU JOUR - 100% INDÉPENDANT
import SurpriseDuJourDashboard from './pages/SurpriseDuJourDashboard';
import SurpriseDuJourProbabilities from './pages/SurpriseDuJourProbabilities';
import SurpriseDuJourRewards from './pages/SurpriseDuJourRewards';
import SurpriseDuJourAntiCheat from './pages/SurpriseDuJourAntiCheat';
import SurpriseDuJourSettings from './pages/SurpriseDuJourSettings';
import SurpriseDuJourTest from './pages/SurpriseDuJourTest';
      ...
      <BrowserRouter basename="/">
        <Routes>
          ...
          <Route path="/" element={<Layout />}>
            ...
            {/* ROUTES SURPRISE DU JOUR - MODULE INDÉPENDANT */}
            <Route path="surprise-du-jour" element={<SurpriseDuJourDashboard />} />
            <Route path="surprise-du-jour/probabilities" element={<SurpriseDuJourProbabilities />} />
            <Route path="surprise-du-jour/rewards" element={<SurpriseDuJourRewards />} />
            <Route path="surprise-du-jour/anti-cheat" element={<SurpriseDuJourAntiCheat />} />
            <Route path="surprise-du-jour/settings" element={<SurpriseDuJourSettings />} />
            <Route path="surprise-du-jour/test" element={<SurpriseDuJourTest />} />
          </Route>
