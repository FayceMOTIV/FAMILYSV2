...
async def create_complete_test_data():
    ...
    products_data = [
        # Burgers
        {
            ...
            "image": "/uploads/products/family-original.jpg",
            "price": 9.90,
            "is_available": True,
        ...
        },
        {
            ...
            "image": "/uploads/products/double-cheese.jpg",
            "price": 11.90,
            "is_available": True,
            "option_ids": [options_data[0]["id"], options_data[1]["id"], options_data[2]["id"], options_data[4]["id"]],
            "created_at": datetime.now(timezone.utc).isoformat()
        },
        {
            ...
            "image": "/uploads/products/bacon-bbq.jpg",
            "price": 12.50,
            "is_available": True,
            "option_ids": [options_data[0]["id"], options_data[1]["id"], options_data[2]["id"], options_data[4]["id"]],
            "created_at": datetime.now(timezone.utc).isoformat()
        },
        {
            ...
            "image": "/uploads/products/veggie.jpg",
            "price": 10.50,
            "is_available": True,
        ...
        },
        {
            ...
            "image": "/uploads/products/chicken-crispy.jpg",
            "price": 9.50,
            "is_available": True,
            "option_ids": [options_data[1]["id"], options_data[2]["id"], options_data[4]["id"]],
            "created_at": datetime.now(timezone.utc).isoformat()
        ...
        # Accompagnements
        {
            ...
            "image": "/uploads/products/fries.jpg",
            "price": 3.50,
            "is_available": True,
        ...
        },
        {
            ...
            "image": "/uploads/products/nuggets.jpg",
            "price": 5.90,
            "is_available": True,
            "option_ids": [options_data[1]["id"]],
            "created_at": datetime.now(timezone.utc).isoformat()
        },
        {
            ...
            "image": "/uploads/products/onion-rings.jpg",
            "price": 4.50,
            "is_available": True,
            "option_ids": [options_data[1]["id"]],
            "created_at": datetime.now(timezone.utc).isoformat()
        ...
        # Boissons
        {
            ...
            "image": "/uploads/products/coca.jpg",
            "price": 2.50,
            "is_available": True,
        ...
        },
        {
            ...
            "image": "/uploads/products/orangina.jpg",
            "price": 2.50,
            "is_available": True,
            "option_ids": [options_data[3]["id"]],
            "created_at": datetime.now(timezone.utc).isoformat()
        },
        {
            ...
            "image": "/uploads/products/lemonade.jpg",
            "price": 3.50,
            "is_available": True,
            "option_ids": [options_data[3]["id"]],
            "created_at": datetime.now(timezone.utc).isoformat()
        ...
        },
        {
            ...
            "image": "/uploads/products/brownie.jpg",
            "price": 4.50,
            "is_available": True,
            "option_ids": [],
            "created_at": datetime.now(timezone.utc).isoformat()
        ...
        # Salades
        {
            ...
            "image": "/uploads/products/caesar.jpg",
            "price": 8.90,
            "is_available": True,
            "option_ids": [],
            "created_at": datetime.now(timezone.utc).isoformat()
