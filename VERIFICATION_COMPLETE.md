...
# Products  
curl "https://resto-dashboard-21.preview.emergentagent.com/api/v1/admin/products"

# Options
curl "https://resto-dashboard-21.preview.emergentagent.com/api/v1/admin/options"

# Orders
curl "https://resto-dashboard-21.preview.emergentagent.com/api/v1/admin/orders"

# Notifications
curl "https://resto-dashboard-21.preview.emergentagent.com/api/v1/admin/notifications"

# Promos
curl "https://resto-dashboard-21.preview.emergentagent.com/api/v1/admin/promos"
```
